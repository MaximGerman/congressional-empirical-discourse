...
*Last updated: 2026-05-18 18:03:34*

| Column              | Type                   | Null %   | Unique    | Samples                                                                                                                                                                                                                                                                                                                                                                                  |
|:--------------------|:-----------------------|:---------|:----------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `hearing_id`        | string[pyarrow]        | 0.0%     | 4,474     | hhrg23825-115, hhrg23826-115, hhrg23827-115                                                                                                                                                                                                                                                                                                                                              |
| `speaker`           | string[pyarrow]        | 0.0%     | 2,441     | Chairman CHABOT, Ms. VELAZQUEZ, Mr. EVANS                                                                                                                                                                                                                                                                                                                                                |
| `speaker_last_name` | string[pyarrow]        | 0.0%     | 1,345     | CHABOT, VELAZQUEZ, EVANS                                                                                                                                                                                                                                                                                                                                                                 |
| `context_before`    | string                 | 16.0%    | 3,006,248 | The Committee will come to order., Good morning., We want to thank everyone for being here with us today so that we can discuss a critical issue facing America's small businesses, what I could consider to be a catastrophe our health insurance marketplace.                                                                                                                          |
| `target_sentence`   | string                 | 0.0%     | 3,577,860 | The Committee will come to order., Good morning., We want to thank everyone for being here with us today so that we can discuss a critical issue facing America's small businesses, what I could consider to be a catastrophe our health insurance marketplace.                                                                                                                          |
| `context_after`     | string                 | 16.6%    | 2,985,565 | Good morning., We want to thank everyone for being here with us today so that we can discuss a critical issue facing America's small businesses, what I could consider to be a catastrophe our health insurance marketplace., In my opinion, and in the opinion of many, President Obama's signature legislation has proven to be a disaster, especially for America's small businesses. |
| `congress`          | int64[pyarrow]         | 0.0%     | 4         | 115, 116, 117                                                                                                                                                                                                                                                                                                                                                                            |
| `chamber`           | string[pyarrow]        | 0.0%     | 1         | house                                                                                                                                                                                                                                                                                                                                                                                    |
...
| `committee_code`    | string[pyarrow]        | 0.7%     | 23        | hssm00, hsed00, hspw00                                                                                                                                                                                                                                                                                                                                                                   |
| `committee_name`    | string[pyarrow]        | 1.0%     | 26        | Committee on Small Business, Committee on Education and the Workforce, Committee on Transportation and Infrastructure                                                                                                                                                                                                                                                                    |
| `hearing_date`      | timestamp[ns][pyarrow] | 0.0%     | 801       | 2017-02-07 00:00:00, 2017-02-01 00:00:00, 2017-02-02 00:00:00                                                                                                                                                                                                                                                                                                                            |
| `bioguide_id`       | string[pyarrow]        | 1.1%     | 704       | C000266, V000081, E000296                                                                                                                                                                                                                                                                                                                                                                |
| `member_first_name` | string[pyarrow]        | 1.1%     | 398       | STEVE, NYDIA, DWIGHT                                                                                                                                                                                                                                                                                                                                                                     |
| `party`             | string[pyarrow]        | 1.1%     | 4         | Republican, Democratic, Independent                                                                                                                                                                                                                                                                                                                                                      |
| `member_state`      | string[pyarrow]        | 1.1%     | 56        | Ohio, New York, Pennsylvania                                                                                                                                                                                                                                                                                                                                                             |
| `match_score`       | double[pyarrow]        | 1.1%     | 16        | 100.0, 88.88888888888889, 85.71428571428572                                                                                                                                                                                                                                                                                                                                              |
| `match_type`        | string[pyarrow]        | 1.1%     | 5         | hearing_member_exact, fuzzy, congress_exact                                                                                                                                                                                                                                                                                                                                              |
| `minority`          | int8[pyarrow]          | 1.1%     | 2         | 0, 1                                                                                                                                                                                                                                                                                                                                                                                     |
| `unified`           | int64[pyarrow]         | 0.0%     | 2         | 1, 0                                                                                                                                                                                                                                                                                                                                                                                     |
| `minuni`            | int8[pyarrow]          | 1.1%     | 2         | 0, 1                                                                                                                                                                                                                                                                                                                                                                                     |
| `dem`               | int8[pyarrow]          | 1.1%     | 2         | 0, 1                                                                                                                                                                                                                                                                                                                                                                                     |
| `nominate_dim1`     | double[pyarrow]        | 1.7%     | 501       | 0.542, -0.547, -0.473                                                                                                                                                                                                                                                                                                                                                                    |
| `nominate_dim2`     | double[pyarrow]        | 1.7%     | 498       | -0.137, -0.37, -0.159                                                                                                                                                                                                                                                                                                                                                                    |
| `state_abbrev`      | string[pyarrow]        | 1.6%     | 56        | OH, NY, PA                                                                                                                                                                                                                                                                                                                                                                               |
| `district_code`     | double[pyarrow]        | 1.6%     | 54        | 1.0, 7.0, 2.0                                                                                                                                                                                                                                                                                                                                                                            |
| `abs_dwnom1`        | double[pyarrow]        | 1.7%     | 400       | 0.542, 0.547, 0.473                                                                                                                                                                                                                                                                                                                                                                      |
| `seniority`         | double[pyarrow]        | 1.6%     | 26        | 11.0, 13.0, 2.0                                                                                                                                                                                                                                                                                                                                                                          |
| `seniority_sq`      | double[pyarrow]        | 1.6%     | 26        | 121.0, 169.0, 4.0                                                                                                                                                                                                                                                                                                                                                                        |
| `freshman`          | double[pyarrow]        | 1.6%     | 2         | 0.0, 1.0                                                                                                                                                                                                                                                                                                                                                                                 |
| `abs_dwnom1_rs`     | double[pyarrow]        | 1.7%     | 1,175     | 0.7611111111111111, 0.7711111111111111, 0.6022222222222222                                                                                                                                                                                                                                                                                                                               |
| `seniority_rs`      | double[pyarrow]        | 1.6%     | 82        | 0.85, 0.9122222222222223, 0.2111111111111111                                                                                                                                                                                                                                                                                                                                             |
| `seniority_sq_rs`   | double[pyarrow]        | 1.6%     | 82        | 0.7224999999999999, 0.8321493827160494, 0.0445679012345679                                                                                                                                                                                                                                                                                                                               |
| `chairspeech`       | int64[pyarrow]         | 0.0%     | 2         | 1, 0                                                                                                                                                                                                                                                                                                                                                                                     |
| `rankmemspeech`     | int64[pyarrow]         | 0.0%     | 2         | 0, 1                                                                                                                                                                                                                                                                                                                                                                                     |
| `leader`            | int64[pyarrow]         | 0.0%     | 2         | 1, 0                                                                                                                                                                                                                                                                                                                                                                                     |
| `vote_pct`          | double[pyarrow]        | 4.0%     | 1,593     | 59.194223028963776, 80.11237637873641, 90.17713095387884                                                                                                                                                                                                                                                                                                                                 |
| `vote_pct_sq`       | double[pyarrow]        | 4.0%     | 1,593     | 3503.9560400027053, 6417.992849048324, 8131.914947073014                                                                                                                                                                                                                                                                                                                                 |
